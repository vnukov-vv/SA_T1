...
- [x] Клиент прошел аутентификацию и авторизацию
...
4.1 Back предварительно валидирует полученные параметры в БД.
4.2 Back инициирует создание новой записи в БД.
  - Если Back вернул ошибки 4xx, 5xx см. альтернативный сценарий 1.
5. Back получает подтверждение завершения транзакции и отдаёт результат на Front
6. Front отображает детальную информацию по счету в соответствии с п. [Макеты](#макеты).
